...
import (
	...
	context "context"
	errors "errors"
	v1 "invoice-manager/main/proto/ping/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceFailProcedure = "/ping.v1.PingService/Fail"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	pingServiceServiceDescriptor    = v1.File_ping_v1_ping_proto.Services().ByName("PingService")
...
// Fail calls ping.v1.PingService.Fail.
...
func (UnimplementedPingServiceHandler) Fail(context.Context, *connect.Request[v1.FailRequest]) (*connect.Response[v1.FailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ping.v1.PingService.Fail is not implemented"))
}
