...
import (
	...
	context "context"
	errors "errors"
	proto "invoice-manager/main/proto"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PingServiceName = "proto.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/proto.PingService/Ping"
	// PingServiceFailProcedure is the fully-qualified name of the PingService's Fail RPC.
	PingServiceFailProcedure = "/proto.PingService/Fail"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	pingServiceServiceDescriptor    = proto.File_proto_proto.Services().ByName("PingService")
...
// PingServiceClient is a client for the proto.PingService service.
type PingServiceClient interface {
	Ping(context.Context, *connect.Request[proto.PingRequest]) (*connect.Response[proto.PingResponse], error)
	Fail(context.Context, *connect.Request[proto.FailRequest]) (*connect.Response[proto.FailResponse], error)
}

// NewPingServiceClient constructs a client for the proto.PingService service. By default, it uses
...
func NewPingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PingServiceClient {
	...
	return &pingServiceClient{
		...
		fail: connect.NewClient[proto.FailRequest, proto.FailResponse](
			httpClient,
...
type pingServiceClient struct {
	...
	fail *connect.Client[proto.FailRequest, proto.FailResponse]
}

// Ping calls proto.PingService.Ping.
...
// Fail calls proto.PingService.Fail.
func (c *pingServiceClient) Fail(ctx context.Context, req *connect.Request[proto.FailRequest]) (*connect.Response[proto.FailResponse], error) {
	return c.fail.CallUnary(ctx, req)
}

// PingServiceHandler is an implementation of the proto.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[proto.PingRequest]) (*connect.Response[proto.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.PingService.Ping is not implemented"))
}

func (UnimplementedPingServiceHandler) Fail(context.Context, *connect.Request[proto.FailRequest]) (*connect.Response[proto.FailResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.PingService.Fail is not implemented"))
}
