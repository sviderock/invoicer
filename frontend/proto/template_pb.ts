...
export class FileUploadResponse extends Message<FileUploadResponse> {
	...
	static equals(
		a: FileUploadResponse | PlainMessage<FileUploadResponse> | undefined,
		b: FileUploadResponse | PlainMessage<FileUploadResponse> | undefined
	): boolean {
...
export class GetTemplatesResponse extends Message<GetTemplatesResponse> {
	...
	static equals(
		a: GetTemplatesResponse | PlainMessage<GetTemplatesResponse> | undefined,
		b: GetTemplatesResponse | PlainMessage<GetTemplatesResponse> | undefined
	): boolean {
